...
if(isset($_POST['tambah'])) {
    ...
    if(empty($nis && $nama && $tempat_lahir && $tgl_lahir && $jk && $prodi)) {
        echo "<script>alert('Pastikan anda sudah mengisi semua formulir.');window.location='?p=buku';</script>";
    }

	$sql = $conn->query("INSERT INTO tb_anggota VALUES (null, '$nis', '$nama', '$tempat_lahir', '$tgl_lahir', '$jk', '$prodi')") or die(mysqli_error($conn));
	if($sql) {
...
<div class="card-header mb-5">
    ...
    <div class="form-group">
        ...
        <input class="form-control" id="nis" name="nis" type="number" placeholder="Masukan nis anggota"/>
    </div>
    <div class="form-group">
